...
static iree_status_t iree_hal_amdgpu_host_post_retire(
  ...
  iree_status_t status = iree_hal_amdgpu_queue_retire_entry(queue, entry);
...
static iree_status_t iree_hal_amdgpu_host_worker_issue_agent_dispatch(
  ...
  fprintf(stderr,
          ...
          ")\n",
          packet->type, packet->return_address, packet->arg[0], packet->arg[0],
          packet->arg[1], packet->arg[1], packet->arg[2], packet->arg[2],
          packet->arg[3], packet->arg[3]);

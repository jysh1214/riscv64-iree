...
// controlled. Since each agent is meant to represent an entire nodes instead of
// cores within those nodes we'll need a 64-socket NUMA machine before we reach
// the current limit. For reference the Linux CPU_SET/CPU_SETSIZE is 1024 and
// that's a core count.
